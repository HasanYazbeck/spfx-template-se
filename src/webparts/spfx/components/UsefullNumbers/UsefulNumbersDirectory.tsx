...
export class UsefullNumbersDirectory extends React.Component<
  IUsefullNumberProps,
  IUsefullNumberState
> {
  ...
  private handleCategoryChange = (
    ...
    const selectedCategory: HTMLSelectElement = document.getElementById(
      "Category",
    ) as HTMLSelectElement;
    const searchQuery: HTMLInputElement = document.getElementById(
      "UseFullNumbersSearchBar",
    ) as HTMLInputElement;
    ...
    if (selectedCategoryValue !== "" && query !== "") {
      ...
      this.setState({ categoryError: false, selectedItem: undefined });
        ...
        <div className={`${styles.profileHeader}`}>
          <div className={`${styles.itemDetails}`}>
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="RankAr" className={`p-3 col-md-2`}>
                Rank
              </label>
              <input
                type="text"
                id="RankAr"
                value={
                  this.state.selectedItem.RankAr !== null
                    ? this.state.selectedItem.RankAr
                    : ""
                }
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="MilitaryId" className={`p-3 col-md-2`}>
                Military Id
              </label>
              <input
                type="text"
                id="MilitaryId"
                value={
                  this.state.selectedItem.MilitaryId !== null
                    ? this.state.selectedItem.MilitaryId
                    : ""
                }
                className={`${styles.formControl}`}
                disabled
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="FullName" className={`p-3 col-md-2`}>
                Name
              </label>
              <input
                type="text"
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="Email" className={`p-3 col-md-2`}>
                Email
              </label>
              <input
                type="text"
                id="Email"
                value={
                  this.state.selectedItem.Email !== null
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="Mobile" className={`p-3 col-md-2`}>
                Mobile
              </label>
              <input
                type="text"
                id="Mobile"
                value={
                  this.state.selectedItem.Mobile !== null
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="Landline" className={`p-3 col-md-2`}>
                Landline
              </label>
              <input
                type="text"
                id="Landline"
                value={
                  this.state.selectedItem.Landline !== null
                    ? this.state.selectedItem.Landline
                    : ""
                }
                className={`${styles.formControl}`}
                disabled
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="Address" className={`p-3 col-md-2`}>
                Address
              </label>
              <input
                type="text"
                id="Address"
                value={
                  this.state.selectedItem.Address !== null
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="BloodType" className={`p-3 col-md-2`}>
                Blood Type
              </label>
              <input
                type="text"
                id="BloodType"
                value={
                  this.state.selectedItem.BloodType !== null
                    ? this.state.selectedItem.BloodType
                    : ""
                }
                className={`${styles.formControl}`}
                disabled
    ...
    return (
      <div className={`${styles.profileContainer}`}>
        <div className={`${styles.profileHeader}`}>
          <div className={`${styles.itemDetails}`}>
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="title" className={`p-3 col-md-2`}>
                Name
              </label>
              <input
                type="text"
                id="title"
                value={
                  this.state.selectedItem.Title !== undefined
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="number" className={`p-3 col-md-2`}>
                Number
              </label>
              <input
                type="text"
            ...
            <div className={`row align-items-center col-md-12`}>
              <label htmlFor="region" className={`p-3 col-md-2`}>
                Region
              </label>
              <input
                type="text"
                id="region"
                value={this.state.selectedItem.Region}
                className={`${styles.formControl}`}
                disabled
              />
            </div>
  ...
  public render(): React.ReactElement<{}> {
    const selectedSold: boolean =
      this.state.selectedCategory !== undefined &&
      this.state.selectedCategory.Title === "Soldiers"
        ? true
        : false;
    return (
      <div className="directory-container">
        <div className="mt-1 position-relative row">
          <div className="col-md-4">
            <select
              id="Category"
              className={`form-select ${this.state.categoryError ? "border-danger" : ""}`}
          ...
          <div className="col-md-8">
            <SearchBar
              ...
              keyId={"UseFullNumbersSearchBar"}
              itemTitle="Usefull Numbers"
              OnChange={(e) =>
                this.handleCategoryChange(e, "UseFullNumbersSearchBar")
              }
        ...
        {this.state.selectedItem !== undefined && !selectedSold && (
          <this.otherPage />
        )}
        {this.state.selectedItem !== undefined && selectedSold && (
          <this.soldierPage />
  ...
  private searchUsefullNumber = (
    ...
    try {
      ...
      if (listName === "Soldiers") {
        query =
          `?$filter=substringof('${numberTitle}',FirstName) or substringof('${numberTitle}',LastName)` +
        ...
        this.spCrudOperations
          ...
          .then((data) => {
            data.map((obj) => {
              const temp: {} = {
                MilitaryId:
                  obj.MilitaryId !== undefined && obj.MilitaryId !== null
                    ? obj.MilitaryId
                    : "",
                FullName:
                  obj.FullName !== undefined && obj.FullName !== null
                    ? obj.FullName.charAt(0).toUpperCase() +
                      obj.FullName.slice(1)
                    : "",
                Mobile:
                  obj.Mobile !== undefined && obj.Mobile !== null
                    ...
                    : "",
                Landline:
                  obj.Landline !== undefined && obj.Landline !== null
                    ? obj.Landline
                    : "",
                Address:
                ...
                EmergencyContactNumber:
                  obj.EmergencyContactNumber !== undefined &&
                  obj.EmergencyContactNumber !== null
                    ? obj.EmergencyContactNumber
                    : "",
                BloodType:
                  obj.BloodType !== undefined && obj.BloodType !== null
                    ? obj.BloodType
                    : "",
                Driver:
                  obj.Driver !== undefined && obj.Driver !== null
                    ? obj.Driver
                    : "",
                Rank:
                ...
                RankAr:
                  obj.Rank !== undefined && obj.Rank !== null
                    ...
                    : "",
                Squads:
                  obj.Squads !== undefined && obj.Squads !== null
                    ? obj.Squads.Title
                    : "",
                SquadsAr:
                  obj.Squads !== undefined && obj.Squads !== null
          ...
          .catch((error) => {
            ...
            console.error(
              "An error has occurred while retrieving items!",
              error,
            );
          });
      } else {
        query =
          `?$filter=substringof('${numberTitle}',Title)` +
