...
export class Modal extends React.Component<IModalProps<any>, IModalState<any>> {
    state: IModalState<any> = {
        showModal: false
    };

    constructor(props: IModalProps<any>) {
        super(props);
    }
...
public render(): React.ReactElement<{}> {
    return (
        <div className={`modal show ${this.props.showModal ? 'd-block' : ''}`} tabIndex={-1}>
                  ...
                  <div className='modal-body'>
                    ...
                    {this.props.showSaveButton && 
                      <div className='modal-footer'>
                        ...
                        onClick={this.props.onSave}>{this.props.buttonText !== undefined ? this.props.buttonText : 'Save'}</button>
                     </div>
                    }
                </div>
              </div>
